...
import { getAllDoctor } from "../../actions/doctorAction";
...
Index.propTypes = {
    ...
    getAllDoctor: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {
    logoutUser, getAllDoctor, bookingDoctor
})(Index);
